...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#horse-pops-plot width=70%}


We can see from @horse-pops-plot that Ontario, Saskatchewan and Alberta 
...
![](../results/horse_pop_plot_largest_sd.png){#fig-horse_pops_plot width=70%}
